...
gact1 <- mx.symbol.relu(gbn1, name='gact1')
...
gact2 <- mx.symbol.relu(gbn2, name='gact2')
...
graph.viz(G_sym, direction = "LR", shape=input_shape_G)
graph.viz(D_sym, direction = "LR", shape=list(data = input_shape_D, digit = c(10, batch_size)))
